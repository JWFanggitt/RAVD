...
from models.attentions import Transformer2DModel,TransformerTemporalModel

from models.attentions import TemporalConvLayer
    ...
    bbx=None):
        ...
        for resnet, temp_conv, attn, temp_attn in zip(
            ...
            if self.gradient_checkpointing:
                ...
                if num_frames > 1:
                    hidden_states = temp_attn(hidden_states, num_frames=num_frames,bbx=None).sample
