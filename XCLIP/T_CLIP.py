...
# triplet_loss = torch.nn.TripletMarginLoss(margin=1.0,p=2.0,eps=1e-5,swap=False,reduction="mean")
...
# def creation(clip1, clip2, clip3, clip4,label):
    ...
    for epoch in range(0 ,10):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(model):
                ...
                # label_id = torch.eye(2).to(device)
                # in_traloss=creation(clip1,clip2,clip3,clip4,label_id)
