...
from diffusers.models.attention import Attention as Cross_Attention
...
if __name__ == "__main__":
    net = GatedSelfAttentionDense(query_dim=1024, context_dim=1024, n_heads=8, d_head=64)

    image = torch.randn(1,77,1024)
    bbx = torch.randn(1,16,1024)
    out =net(image, bbx)
    print(out.shape)
